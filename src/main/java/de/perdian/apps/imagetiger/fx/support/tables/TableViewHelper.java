 ...
 */
package de.perdian.apps.imagetiger.fx.support.tables;
...
public class TableViewHelper {
    ...
    public static <T> Callback<TableColumn<T, Boolean>, TableCell<T, Boolean>> createIconCellCallback(Ikon trueIcon, Ikon falseIcon) {
        return column -> {
